...
# Email settings
ACCOUNT_EMAIL_SUBJECT_PREFIX = config('ACCOUNT_EMAIL_SUBJECT_PREFIX', default='[Cup Streaming] ')
ACCOUNT_DEFAULT_HTTP_PROTOCOL = config('ACCOUNT_DEFAULT_HTTP_PROTOCOL', default='https')

# Login / security
ACCOUNT_RATE_LIMITS = {"login_failed": config('ACCOUNT_LOGIN_FAILED_RATE_LIMIT', default='5/300s')}  # replaces LOGIN_ATTEMPTS_LIMIT/TIMEOUT
...
CACHES = {
    "default": {
        ...
        "LOCATION": config('CACHE_LOCATION', default='unique-snowflake'),  # just an identifier
    }
}
...
DEFAULT_FROM_EMAIL = config(
    'DEFAULT_FROM_EMAIL', default='noreply@cupstreaming.com')
...
CSP_STYLE_SRC = tuple(config('CSP_STYLE_SRC', default="'self','unsafe-inline'", cast=Csv()))
