...
class BaseAPIView(APIView):
    ...
    def error_response(
        self, message="Error", code=400, status_code=status.HTTP_400_BAD_REQUEST
    ):
        """
        Return a standardized error response.
        """
        response_data = {"code": code, "message": message, "data": None}
    ...
    def not_found_response(self, message="Resource not found"):
        ...
        return self.error_response(
            message=message, code=404, status_code=status.HTTP_404_NOT_FOUND
        )
    ...
    def unauthorized_response(self, message="Unauthorized"):
        ...
        """
        return self.error_response(
            message=message, code=401, status_code=status.HTTP_401_UNAUTHORIZED
        )
    ...
    def forbidden_response(self, message="Forbidden"):
        ...
        """
        return self.error_response(
            message=message, code=403, status_code=status.HTTP_403_FORBIDDEN
        )
    ...
    def server_error_response(self, message="Internal server error"):
        ...
        """
        return self.error_response(
            message=message, code=500, status_code=status.HTTP_500_INTERNAL_SERVER_ERROR
        )
...
class HealthCheckView(BaseAPIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return self.success_response(data=health_data, message="API is healthy")
...
class ProtectedView(BaseAPIView):
    ...
    def get(self, request):
        ...
        return self.success_response(
            data=user_data, message="Protected data retrieved successfully"
        )
...
class WebhookView(BaseAPIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return self.success_response(
                data={"received": True}, message="Webhook processed successfully"
            )
        except Exception as e:
