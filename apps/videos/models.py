...
class Video(models.Model):
    ...
    duration = models.FloatField(verbose_name=_('Duration (seconds)'), help_text=_('Duration in seconds'))
    thumbnail_url = models.URLField(max_length=500, blank=True, null=True, verbose_name=_('Thumbnail URL'))
    ...
    # Video metadata
    file_size = models.BigIntegerField(blank=True, null=True, verbose_name=_('File Size (bytes)'))
    resolution = models.CharField(max_length=20, blank=True, null=True, verbose_name=_('Resolution'))
    format = models.CharField(max_length=10, blank=True, null=True, verbose_name=_('Format'))
    ...
    s3_key = models.CharField(max_length=500, blank=True, null=True, verbose_name=_('S3 Key'))
